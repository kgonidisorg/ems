    ...
    return await CacheManager.getCachedData(
      ...
      async () => {
        try {
          ...
          console.error(`Error fetching site overview for site ${siteId}:`, error);
          throw new Error(`Failed to fetch site overview for site ${siteId}`);
        }
      },
...
export const DeviceService = {
    ...
    return await CacheManager.getCachedData(
      ...
      async () => {
        try {
          ...
          return await apiRequest<Device[]>(() => apiGateway.get(url));
        } catch (error) {
   ...
   * Get devices by type
   */
  async getDevicesByType(deviceType: string, siteId?: number): Promise<Device[]> {
    ...
    return await CacheManager.getCachedData(
      ...
      async () => {
        try {
          ...
          throw new Error(`Failed to fetch devices of type ${deviceType}`);
        }
      },
      60000 // 1 minute cache
    );
...
export const AnalyticsService = {
   ...
   */
  async getEnergyConsumption(params: EnergyConsumptionParams = {}): Promise<EnergyConsumptionResponse> {
      ...
      async () => {
        try {
          return await apiRequest<EnergyConsumptionResponse>(() =>
            apiGateway.get('/analytics/energy-consumption', { params })
          );
        } catch (error) {
   ...
   */
  async getCarbonFootprint(params: CarbonFootprintParams = {}): Promise<CarbonFootprintResponse> {
      ...
      async () => {
        try {
          return await apiRequest<CarbonFootprintResponse>(() =>
            apiGateway.get('/analytics/carbon-footprint', { params })
          );
        } catch (error) {
      ...
      async () => {
        try {
          return await apiRequest<FinancialMetricsResponse>(() =>
            apiGateway.get('/analytics/financial-metrics', { params })
          );
        } catch (error) {
   ...
   */
  async getSiteAnalytics(siteId: number, params: Record<string, unknown> = {}): Promise<Record<string, unknown>> {
    ...
    return await CacheManager.getCachedData(
      ...
      async () => {
        try {
          ...
          console.error(`Error fetching analytics for site ${siteId}:`, error);
          throw new Error(`Failed to fetch analytics for site ${siteId}`);
        }
      },
